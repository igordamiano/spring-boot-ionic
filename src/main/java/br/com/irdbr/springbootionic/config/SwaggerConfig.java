...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				// .apis(RequestHandlerSelectors.any()) // Projeto inteiro
				.apis(RequestHandlerSelectors.basePackage("br.com.irdbr.springbootionic.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				"API Spring Boot Ionic",
				"Esta API é utilizada para Spring Boot do Igor", 
				"Versão 1.0",
				"https://www.termosDeUsodaAPI.com",
				new Contact("Igor Rodrigues Damiano", "www.irdbr.com.br", "irdbr.app@gmail.com"),
				"Permitido uso para estudantes",
				"https://www.termosDeUso.com", 
